...
$breadcrumbs = array(
    ...
    array('title' => $community->name, 'url' => home_url('/communities/' . $community->slug)),
    array('title' => 'Conversations')
);
$nav_items = array(
    array('title' => 'Overview', 'url' => home_url('/communities/' . $community->slug)),
    array('title' => 'Conversations', 'url' => home_url('/communities/' . $community->slug . '/conversations'), 'active' => true),
                    ...
                    <?php if ($total_conversations > $per_page): ?>
                        ...
                        <div class="pm-pagination pm-text-center pm-mt-4">
                            ...
                            <span class="pm-pagination-info">
                                <?php printf(__('Page %d of %d', 'partyminder'), $page, $total_pages); ?>
                            </span>
...
<div class="pm-section pm-mb">
    <div class="pm-card">
        <div class="pm-card-header">
            <h3 class="pm-heading pm-heading-md">Community Info</h3>
        </div>
        <div class="pm-card-body">
            <div class="pm-text-center pm-mb-4">
                <div class="pm-avatar pm-avatar-xl pm-mb-2">
                    <?php echo strtoupper(substr($community->name, 0, 2)); ?>
                </div>
                <h4 class="pm-heading pm-heading-sm"><?php echo esc_html($community->name); ?></h4>
            ...
            <?php if ($community->description): ?>
                <div class="pm-text-muted pm-mb-4">
                    <?php echo wpautop(esc_html($community->description)); ?>
                </div>
            <?php endif; ?>
            
            <div class="pm-stats-grid pm-text-center">
                <div class="pm-stat">
                ...
                <div class="pm-stat">
                    <div class="pm-stat-number pm-text-primary"><?php echo $total_conversations; ?></div>
    ...
    <div class="pm-card">
        ...
        <div class="pm-card-body">
            <div class="pm-flex pm-flex-column pm-gap">
                ...
                <?php else: ?>
                    <a href="#" class="pm-btn join-community-btn" data-community-id="<?php echo esc_attr(intval($community->id)); ?>">
                        Join Community
                    </a>
                <?php endif; ?>
            </div>

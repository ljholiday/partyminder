...
$page_description = sprintf( __( '%1$s - %2$s', 'partyminder' ), $event_date->format( 'l, F j, Y' ), ( $event->venue_info ? esc_html( $event->venue_info ) : '' ) );
	...
	<?php else : ?>
		...
		<div class="partyminder-form layout-<?php echo esc_attr( $form_layout ); ?>">
			...
			<form method="post" class="pm-form partyminder-rsvp-form" id="pm-modal-rsvp-form">
				...
				<!-- Guest Information -->
				<div class="pm-mb-4">
					<h3 class="pm-heading pm-heading-md pm-text-primary mb-4"><?php _e( 'Your Information', 'partyminder' ); ?></h3>
				...
				<!-- RSVP Status -->
				<div class="pm-mb-4">
					<h3 class="pm-heading pm-heading-md pm-text-primary mb-4"><?php _e( 'Will You Attend?', 'partyminder' ); ?></h3>

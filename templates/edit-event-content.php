...
<?php if ( $event_updated ) : ?>
	...
	<div class="pm-alert pm-alert-success pm-mb-4">
		...
		<div class="pm-success-actions">
			...
			<button type="button" onclick="navigator.share({title: 'Check out this event!', url: '<?php echo esc_js( home_url( '/events/' . $event->slug ) ); ?>'}) || navigator.clipboard.writeText('<?php echo esc_js( home_url( '/events/' . $event->slug ) ); ?>')" class="pm-btn">

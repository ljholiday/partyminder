...
class PartyMinder {
    ...
    public function dashboard_shortcode($atts) {
        ...
        echo '<a href="' . esc_url(self::get_dashboard_url()) . '" class="btn">' . __('Go to Dashboard', 'partyminder') . '</a>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function event_form_shortcode($atts) {
        ...
        echo '<a href="' . esc_url(self::get_create_event_url()) . '" class="btn">' . __('Create Event', 'partyminder') . '</a>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function events_list_shortcode($atts) {
        ...
        echo '<a href="' . esc_url(self::get_events_page_url()) . '" class="btn">' . __('View All Events', 'partyminder') . '</a>';
        echo '<a href="' . esc_url(self::get_create_event_url()) . '" class="btn success">' . __('Create Event', 'partyminder') . '</a>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function my_events_shortcode($atts) {
        ...
        echo '<a href="' . esc_url(self::get_my_events_url()) . '" class="btn">' . __('View My Events', 'partyminder') . '</a>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function conversations_shortcode($atts) {
        ...
        echo '<a href="' . esc_url(self::get_conversations_url()) . '" class="btn">' . __('Join Conversations', 'partyminder') . '</a>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function communities_shortcode($atts) {
        ...
        echo '<a href="' . esc_url(self::get_communities_url()) . '" class="btn">' . __('Browse Communities', 'partyminder') . '</a>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function event_edit_form_shortcode($atts) {
        ...
        if ($event_id) {
            ...
            echo '<a href="' . esc_url(self::get_edit_event_url($event_id)) . '" class="btn">' . __('Edit Event', 'partyminder') . '</a>';
            echo '</div>';
            return ob_get_clean();
        }
    ...
    public function profile_shortcode($atts) {
        ...
        echo '<a href="' . esc_url(self::get_profile_url()) . '" class="btn">' . __('View Profile', 'partyminder') . '</a>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function login_shortcode($atts) {
        ...
        echo '<a href="' . esc_url(self::get_login_url()) . '" class="btn">' . __('Sign In', 'partyminder') . '</a>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function handle_custom_pages() {
        ...
        switch ($page_type) {
            ...
            case 'manage-community':
                // Handle community management page (only if communities enabled) 
                if (PartyMinder_Feature_Flags::is_communities_enabled()) {
                    // Handle community_id parameter
                    if (!get_query_var('community_id') && isset($_GET['community_id'])) {
                        set_query_var('community_id', intval($_GET['community_id']));
                    }
                    add_filter('the_content', array($this, 'inject_manage_community_content'));
                    add_filter('body_class', array($this, 'add_manage_community_body_class'));
                } else {
                    // Feature disabled - redirect to communities page
